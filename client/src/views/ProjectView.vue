    ...
    <div
        ...
        <div class="flex-wrap w-full sm:w-fit flex justify-center">
            <div
                ...
                <textarea @keyup="autoUpdate" v-model="nameProject.name" placeholder="Insert project name..."
            ...
            <div class="flex sm:flex-col justify-around items-center mt-6 ml-4 w-full h-full">
                ...
                <div class="flex justify-center items-center sm:my-5 sm:py-2.5 sm:px-10 w-fit h-fit rounded-lg opacity-70"
                    ...
                    <RouterLink to="/post" @click="setActiveButton('post')">
                        <img width="30" height="30"
                            ...
                            class="bg-snow/40 shadow-lg rounded-lg w-10 sm:w-10 p-1" alt="note" />
                    </RouterLink>
                </div>
                <div class="flex justify-center items-center sm:my-5 sm:py-2.5 sm:px-10 w-fit h-fit rounded-lg opacity-70"
                    v-bind:class="{ 'bg-snow/30 shadow-xl opacity-95': activeButton === 'timer' }">
                    <RouterLink to="/timer" @click="setActiveButton('timer')">
                        <img width="30" height="30" src="https://img.icons8.com/material-rounded/96/1E293B/time.png"
                            class="bg-snow/40 shadow-lg rounded-lg w-10 p-1" alt="timer" />
                    </RouterLink>
                </div>
                <div class="flex justify-center items-center sm:my-5 sm:py-2.5 sm:px-10 w-fit h-fit rounded-lg opacity-70"
                    v-bind:class="{ 'bg-snow/30 shadow-xl opacity-95': activeButton === 'password' }">
                    <RouterLink to="/password" @click="setActiveButton('password')">
                        <img width="30" height="30" src="https://img.icons8.com/metro/104/1E293B/password.png"
                            class="bg-snow/40 shadow-lg rounded-lg w-10 p-1" alt="password" />
                    </RouterLink>
                </div>
                <div class="flex justify-center items-center sm:my-5 sm:py-2.5 sm:px-10 w-fit h-fit rounded-lg opacity-70"
                    ...
                    <RouterLink to="/piggybank" @click="setActiveButton('piggybank')">
                        <img width="30" height="30" src="https://img.icons8.com/ios-filled/100/1E293B/money-box--v1.png"
                            class="bg-snow/40 shadow-lg rounded-lg w-10 p-1" alt="piggybank" />
                    </RouterLink>
                </div>
                <div
                    class="flex justify-center items-center sm:my-5 sm:py-2.5 sm:px-10 w-fit h-fit rounded-lg opacity-70">
                    <RouterLink to="/homepage">
                        <img width="30" height="30" src="https://img.icons8.com/ios-glyphs/90/1E293B/home.png"
                            class="bg-snow/40 shadow-lg rounded-lg w-10 p-1" alt="home" />
                    </RouterLink>
                </div>
            </div>
        </div>
