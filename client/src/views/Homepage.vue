<template>
  <div class="flex flex-col m-0 w-full min-h-screen h-full bg-snow/40 backdrop-blur-3xl">
    <nav class="flex justify-between items-center w-full h-fit p-1 lg:p-2 z-20">
      ...
      <!-- dropdown user menu -->
      <div
        class="flex flex-col items-end lg-1 lg:mr-10"
    ...
    <div class="flex flex-col sm:flex-row h-fit w-full">
      <!-- project list -->
      <ul
        class="min-h-[94vh] lg:min-h-[91vh] h-full items-center w-full sm:w-fit flex flex-col justify-between"
      >
        ...
        <div class="mb-3 z-50">
          <div class="mx-4 my-1.5 flex">
            <div
              class="w-fit justify-center flex flex-col items-center"
      ...
      >
        ...
        >
          <li
            v-for="post in userPostsPinned"
            :key="post._id"
            v-show="post.pin !== false"
            class="flex flex-col bg-ghost rounded-xl border w-full h-[35vh] p-1 m-2"
          >
            <textarea
              @keyup="autoPostUpdate(post._id)"
        ...
        >
          <li
            v-for="password in userPasswordsPinned"
            :key="password._id"
            v-show="password.pin !== false"
          ...
          >
            <div class="resize-none h-fit w-full">
              <textarea
                @keyup="autoPasswordUpdate(password._id)"
